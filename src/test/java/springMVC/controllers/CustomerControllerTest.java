...
public class CustomerControllerTest {
    ...
    public void testSaveOrUpdate() throws Exception {
        ...
        mockMvc.perform(post("/customer")
                        ...
                        .param("shiftingAddress.addressLine1", addressLine1)
                        .param("shiftingAddress.addressLine2", addressLine2)
                        .param("shiftingAddress.city", city)
                        .param("shiftingAddress.state", state)
                        .param("shiftingAddress.zipCode", zipCode)
                        .param("email", email)
                ...
                .andExpect(model().attribute("customer", hasProperty("shiftingAddress", hasProperty("addressLine1", is(addressLine1)))))
                .andExpect(model().attribute("customer", hasProperty("shiftingAddress", hasProperty("addressLine2", is(addressLine2)))))
                .andExpect(model().attribute("customer", hasProperty("shiftingAddress", hasProperty("city", is(city)))))
                .andExpect(model().attribute("customer", hasProperty("shiftingAddress", hasProperty("state", is(state)))))
                .andExpect(model().attribute("customer", hasProperty("shiftingAddress", hasProperty("zipCode", is(zipCode)))))
